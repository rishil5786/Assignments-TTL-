...
This repository contains machine learning, data science, optimization, and deep learning assignments.

---

## 📂 Repository Contents

| Notebook | Topic / Description | Key Libraries & Concepts |
| :--- | :--- | :--- |
| **[Assignment_01.ipynb](Assignment_01.ipynb)** | **Vehicle Specification & Regression Modeling** | `numpy`, `pandas`, `scikit-learn`, `matplotlib` |
| **[Assignment_02.ipynb](Assignment_02.ipynb)** | **Genetic Algorithm & Evolutionary Optimization** | Population modeling, crossover, mutation, selection |
